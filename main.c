...
static int8_t patterns[] = {10101010, 01010101, 11001100, 00110011, 11110000, 00001111};
static int16_t address[]= {0x0000,0x0001,0x0002,0x0003,0x0004,0x0005,0x0006};
int8_t index=1;
/* USER CODE END PV */
...
void TIM16_IRQHandler(void)
{
	...
	if (check(read_from_address(address[index])))
	{
